---
name: specdd-review
description: Use when Cline needs to review a diff, branch, pull request, changed files, or proposed changes against active SpecDD contracts, focusing on spec violations, behavioral regressions, missing checks, and concrete findings.
license: Apache-2.0
---
