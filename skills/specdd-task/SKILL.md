---
name: specdd-task
description: Use when Cline needs to find, add, interpret, organize, or update `Tasks` entries in SpecDD `.sdd` files, including task status changes after implementation and verification are complete.
license: Apache-2.0
---
